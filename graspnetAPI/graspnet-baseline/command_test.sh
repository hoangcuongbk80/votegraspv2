...
CUDA_VISIBLE_DEVICES=0 python3 test.py --dump_dir /media/hoang/HD-PZFU3/datasets/graspnet/predictions --checkpoint_path /media/hoang/HD-PZFU3/datasets/graspnet/checkpoint.tar --camera kinect --dataset_root /media/hoang/HD-PZFU3/datasets/graspnet
